        ...
        i = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: { name: { offsetY: -20, color: a, fontSize: "13px", fontWeight: "400", fontFamily: "Public Sans" }, value: { offsetY: 10, color: t, fontSize: "38px", fontWeight: "500", fontFamily: "Public Sans" } },
                },
            },
        ...
        (s.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (e, t, a, r) {
                        ...
                        return (
                            ...
                            (o
                                ? '<img src="' + assetsPath + "img/icons/brands/" + o + '" alt="Avatar" class="rounded-circle">'
                                : '<span class="avatar-initial rounded-circle bg-label-' +
                                  ["success", "danger", "warning", "info", "primary", "secondary"][Math.floor(6 * Math.random())] +
                                  '">' +
                                  (o = (((o = (s = a.project_name).match(/\b\w/g) || []).shift() || "") + (o.pop() || "")).toUpperCase()) +
                                  "</span>") +
                ...
                },
                {
                    ...
                    searchable: !1,
                    render: function (e, t, a, r) {
                        for (var o = a.team, s = '<div class="d-flex align-items-center avatar-group">', i = 0; i < o.length; i++)
                            s += '<div class="avatar avatar-sm"><img src="' + assetsPath + "img/avatars/" + o[i] + '" alt="Avatar" class="rounded-circle pull-up"></div>';
                        return (s += "</div>");
                    },
                },
                {
